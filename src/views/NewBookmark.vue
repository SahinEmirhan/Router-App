<template>
  <div class="form-area card border p-2">
    <div class="mb-3">
      ...
      <input type="text" v-model="userData.title" class="form-control" id="title" placeholder="Title" />
    </div>
    <div class="mb-3">
      <label for="url" class="form-label">URL</label>
      <input type="text" v-model="userData.url" class="form-control" id="url" placeholder="https://v3.vuejs.org" />
    </div>
    <div class="mb-3">
      <label for="description" class="form-label">Description</label>
      <textarea class="form-control" v-model="userData.description" placeholder="Description..." id="description" rows="3"></textarea>
    </div>
